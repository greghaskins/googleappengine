 ...
 *
 */
class AppEngineUrlFetchClient extends AppEngineClient {

  private final URLFetchService urlFetch = URLFetchServiceFactory.getURLFetchService();

  AppEngineUrlFetchClient(RemoteApiOptions options, List<Cookie> authCookies, String appId) {
  ...
  private static Response createResponse(HTTPResponse resp) {
