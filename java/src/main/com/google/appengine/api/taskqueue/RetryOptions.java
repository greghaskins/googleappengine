 ...
 * Calls to {@link RetryOptions} methods may be chained to specify
 * multiple options in the one {@link RetryOptions} object.
 * <p>Notes on usage:<br>
 * The recommended way to instantiate a {@link RetryOptions} object is to
...
public final class RetryOptions implements Serializable {
  ...
  public boolean equals(Object obj) {
    ...
    if (taskRetryLimit == null) {
      if (other.taskRetryLimit != null) return false;
    } else if (!taskRetryLimit.equals(other.taskRetryLimit)) return false;
    if (taskAgeLimitSeconds == null) {
      if (other.taskAgeLimitSeconds != null) return false;
    } else if (!taskAgeLimitSeconds.equals(other.taskAgeLimitSeconds)) return false;
    if (minBackoffSeconds == null) {
      if (other.minBackoffSeconds != null) return false;
    } else if (!minBackoffSeconds.equals(other.minBackoffSeconds)) return false;
    if (maxBackoffSeconds == null) {
      if (other.maxBackoffSeconds != null) return false;
    } else if (!maxBackoffSeconds.equals(other.maxBackoffSeconds)) return false;
