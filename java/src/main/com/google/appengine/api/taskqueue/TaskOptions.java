 ...
 * <p>taskOptions can have either {@link TaskOptions#Method} PULL or a PUSH-related method,
 ...
 * <p>Notes on usage:<br>
 * The recommended way to instantiate a {@link TaskOptions} object is to
...
public final class TaskOptions implements Serializable {
  ...
  public boolean equals(Object obj) {
    ...
    if (countdownMillis == null) {
      if (other.countdownMillis != null) return false;
    } else if (!countdownMillis.equals(other.countdownMillis)) return false;
    if (etaMillis == null) {
      if (other.etaMillis != null) return false;
    } else if (!etaMillis.equals(other.etaMillis)) return false;
    if (headers == null) {
    ...
    if (retryOptions == null) {
      if (other.retryOptions != null) return false;
    } else if (!retryOptions.equals(other.retryOptions)) return false;
    return true;
  }
