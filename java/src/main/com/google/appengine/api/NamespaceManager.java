 ...
 *
 * <p>
 * The "current namespace" is the string that is returned by {@link #get()} and
 ...
 *
 * <p>
 * MemcacheService {@code memcache} (in the above example) uses the current
 ...
 *
 * <p>
 * The Task Queue {@link com.google.appengine.api.taskqueue.Queue#add}
