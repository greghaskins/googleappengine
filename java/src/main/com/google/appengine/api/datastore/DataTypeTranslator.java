 ...
 * the user-facing classes ({@code String}, {@code User}, etc.).
 *
 */
public final class DataTypeTranslator  {
   ...
   *
   * If the property value is an {@code Entity.UnindexedValue}, or if it's a
  ...
  public static void addPropertiesToPb(Map<String, Object> map, EntityProto proto) {
    for (Map.Entry<String, Object> entry : map.entrySet()) {
      ...
      Object value = Entity.unwrapValue(entry.getValue());
  ...
  private static void addProperty(EntityProto entity, String name, Object value,
    ...
    if (!indexed || (type != null && type.getComparableFunction() == null)) {
  ...
  private static Pair<Type<?>, Property> createProperty(String name, Object value,
    ...
    Property.Meaning meaning = type.getMeaning();
    if (meaning != null) {
  ...
  private static void addPropertyValueToMap(
    ...
    if (property.isMultiple()) {
      ...
      List<Object> results = (List<Object>) Entity.unwrapValue(map.get(name));
      if (results == null) {
  ...
  abstract static class Type<T> {
    ...
    private final Property.Meaning meaning;

    protected Type(Property.Meaning meaning) {
    ...
    /**
     * Returns the {@link Property.Meaning Meaning} for this {@code Type}.
     *
     * @return May return {@code null} to indicate there is no special meaning.
     */
    public Property.Meaning getMeaning() {
      return meaning;
    }
  ...
  private static class BlobKeyType extends CustomStringType<BlobKey> {
    private BlobKeyType() {
      super(Property.Meaning.BLOBKEY);
    }
  ...
  private static class DateType extends Type<Date> {
    private DateType() {
      super(Property.Meaning.GD_WHEN);
    }
  ...
  private static class LinkType extends Type<Link> {
    private LinkType() {
      super(Property.Meaning.ATOM_LINK);
    }
  ...
  private static class ShortBlobType extends Type<ShortBlob> {
    private ShortBlobType() {
      super(Property.Meaning.BYTESTRING);
    }
  ...
  private static abstract class CustomStringType<T> extends Type<T> {
    ...
    private CustomStringType(Property.Meaning meaning) {
      super(meaning);
    }
  ...
  private static abstract class CustomInt64Type<T> extends Type<T> {
    ...
    private CustomInt64Type(Property.Meaning meaning) {
      super(meaning);
    }
  ...
  private static class CategoryType extends CustomStringType<Category> {
    private CategoryType() {
      super(Property.Meaning.ATOM_CATEGORY);
    }
  ...
  private static class RatingType extends CustomInt64Type<Rating> {
    ...
    private RatingType() {
      super(Property.Meaning.GD_RATING);
    }
  ...
  private static class EmailType extends CustomStringType<Email> {
    private EmailType() {
      super(Property.Meaning.GD_EMAIL);
    }
  ...
  private static class PostalAddressType extends CustomStringType<PostalAddress> {
    private PostalAddressType() {
      super(Property.Meaning.GD_POSTALADDRESS);
    }
  ...
  private static class PhoneNumberType extends CustomStringType<PhoneNumber> {
    private PhoneNumberType() {
      super(Property.Meaning.GD_PHONENUMBER);
    }
  ...
  private static class GeoPtType extends Type<GeoPt> {
    ...
    private GeoPtType() {
      super(Property.Meaning.GEORSS_POINT);
    }
